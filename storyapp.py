...
# ---------- Configuration ----------
CHUNKS = [
    "Boundlessly, I trudged through the perpetual, labyrinthic pathway. The fluorescent moon illuminated the deserted cemetery, and the overcast sky was enveloped with fevering clouds. Despite all this, I could see the freckles of silver stars hanging from the sky.",
...
st.write("Try to recall and type each section of the story in order.")
...
user_input = st.text_area("Type from memory:", height=150)
...
if st.button("Check"):
    if user_input.strip() == current_chunk:
        ...
        st.error("❌ Not quite. Try again or reveal the chunk below.")

with st.expander("📖 Show me the correct chunk"):
